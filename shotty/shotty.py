...
@click.option('--project', default=None,
    help="Only volumes for a project (tag Project:<name>)")
...
@click.option('--project', default=None,
    help="Only instances for a project (tag Project:<name>)")
def create_snapshots(project):
    ...
    for i in instances:
        ...
        print("Stopping {0}...".format(tags.get('Name', i.id)))
        ...
        print("Starting {0}...".format(tags.get('Name', i.id)))
